                ...
                child: Column(
                  ...
                  children: [
                    ...
                    HardShadowCard(
                      ...
                      child: Column(
                        children: [
                            _infoRow('ORDER ID', '#${(widget.orderId ?? 'VR-99281').toUpperCase()}'),
                    ...
                    PrimaryButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => TrackingScreen(orderId: widget.orderId)),
                        );
                      },
                    ),
                    const SizedBox(height: 16),
